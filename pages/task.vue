...
import Todo from '~/components/Todo.vue'; // Ensure Todo.vue is also using TypeScript
...
export default defineComponent({
  ...
  ...todo,
  text: 'Some default text or actual text' // Add a default or actual text value
}));
        ...
        onMounted(() => {
            ...
            if (usr) {
                first_name.value = JSON.parse(usr).first_name;
            } else {
                router.push({ name: 'signup' });
            }
            console.warn(route.params.id); // Use route composable to access route parameters
        });
